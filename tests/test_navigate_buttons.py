...
class TestNavigateButtons:
    ...
    def test_click_samokat_logo_navigates_to_main_site(self, order_driver):
        ...
        assert navigate_button.get_current_url() == main_site, 'Текущий url не соответствует ожидаемому'
    ...
    def test_click_yandex_logo_open_dzen_site_in_new_tab(self, order_driver):
        ...
        assert navigate_button.get_current_url() == dzen_site, 'Текущий url не соответствует ожидаемому'
